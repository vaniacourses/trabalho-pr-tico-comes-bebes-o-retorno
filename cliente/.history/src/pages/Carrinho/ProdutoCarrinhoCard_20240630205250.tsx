...
export function ProdutoCarrinhoCard({nome,descricao,id,preco}:ProdutoCardProps){
    ...
    return(
        ...
        <CardFooter className="flex flex-row justify-between">
            ...
            <Button className="text-green-600 bg-white border-2 border-green-600 hover:bg-green-600 hover:text-white" onClick={handleCarrinho}>Excluir do Carrinho</Button>
        </CardFooter>
    </Card>
