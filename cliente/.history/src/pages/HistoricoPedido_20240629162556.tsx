...
export function HistoricoPedido() {
    ...
    useEffect(() => {
        const fetchPedido = async () => {
            try {
                const response = await axios.get(`http://localhost:8080/pedido/12345678910`, {
                    headers: {
                        'Authorization': `eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzZWNyZXQiLCJleHAiOjE3MTk2OTYyMDksInN1YiI6ImZhNDE3YjI5LTA5MzgtNDk0ZS1iMjhmLTQzMzQ0M2EwMjc0NiJ9.4e7wu02hrYA46pSTUUxr4zPQdKMFYJxtqSRL4ghuUO8`
                    }
                });
