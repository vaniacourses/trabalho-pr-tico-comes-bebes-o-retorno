        ...
        const fetchPedido = async () => {
            try {
                const response = await axios.get(`http://localhost:8080/pedido/21332109810`,{
                    headers: {
                      'Authorization': `eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzZWNyZXQiLCJleHAiOjE3MTk2OTQ0NTgsInN1YiI6ImZhNDE3YjI5LTA5MzgtNDk0ZS1iMjhmLTQzMzQ0M2EwMjc0NiJ9.QLOmbdW6A0LZO5Y61fUOwqW0Nf7dRoAjjZdGoZCTv8I`
                }});
