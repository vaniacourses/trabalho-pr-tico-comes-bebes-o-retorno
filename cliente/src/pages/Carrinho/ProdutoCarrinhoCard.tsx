...
interface ProdutoCardProps {
    ...
    descricao: string;
    preco: number;
    onItemRemoved: (id_item: string) => void; // Adiciona a função de callback
}

export function ProdutoCarrinhoCard({ id_item, nome, descricao, id, preco, onItemRemoved }: ProdutoCardProps) {
    ...
    const handleExcluirCarrinho = async () => {
        ...
        try {
            ...
            onItemRemoved(id_item); // Chama a função de callback para atualizar o estado do carrinho
        } catch (err: unknown) {
